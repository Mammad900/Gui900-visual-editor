...
async function LP_Hints() {
    ...
    var hints= [
        ...
        ["projectSettings", "#toolbar>.menuitem:first-of-type>div>.dropdown>.menuitem:nth-child(4)>.toolbar-button"  , "Here you can adjust different settings for the project."                                                                  , true ,"right" ],
        ["saveProject"    , "#toolbar>.menuitem:first-of-type>div>.dropdown>.menuitem:nth-child(2)>.toolbar-button"  , "Here you can save the project to a file, export it to JSON, or save it to the browser storage."                           , true ,"right" ],
        ["openProject"    , "#toolbar>.menuitem:first-of-type>div>.dropdown>.menuitem:first-child>.toolbar-button"   , "Here you can open a previously saved file, import from JSON, or load the last saved project in browser storage."          , true ,"right" ],
        ["generateCode"   , "#toolbar>.menuitem:first-of-type>div>.dropdown>.menuitem:nth-child(3)>.toolbar-button"  , "This tool generates Arduino code to be used in production."                                                               , true ,"right" ],
        ["changeTheme"    , "#toolbar>.menuitem:first-of-type>div>.dropdown>.menuitem:nth-of-type(5)>.toolbar-button", "Change the editor theme here"                                                                                             , false,"right" ],
        ["renameProject"  , "#project-name-container"                                                                , "To change the name of the project, you have to edit this text (it's editable)"                                            , false,"bottom"],
    ]
