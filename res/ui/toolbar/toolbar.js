...
toolBar.makeMenuItemsHideOnClick = function() {
...
toolBar.createMenuItem = function( container, innerHtml, hasChild=false, disabled=false){
...
toolBar.getDropDown = function(element){
    return element.children().children(".dropdown");
}

toolBar.menuItem = function(container,innerHTML,event,callback=function(){},hasChild=true, disabled=false){
...
toolBar.separator = function(container) {
    $(container).append($("<hr>"));
}
 ...
 * @param {string} icon 
 */
toolBar.menuItemIconChange = function(element,icon) {
