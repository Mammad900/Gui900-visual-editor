...
elements.table.rows= elements.table.rows || {};
 ...
 */
elements.table.rows.getRow=function(index){
 ...
 */
elements.table.rows.new=function(name,type,titleEditable=false){
 ...
 */
elements.table.rows.sortNumbers=function(){
